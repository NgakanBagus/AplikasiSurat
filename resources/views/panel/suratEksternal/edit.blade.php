            ...
            <div class="card-body">
              ...
              {{ csrf_field() }}
                <div class="row my-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="judul_surat" id="judul_surat" value="{{ $surat->judul_surat }}" required>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <div class="col-sm-12" style="text-align: right">
                    <input type="hidden" value="{{ $surat->file_name }}" name="old_file">
